...
|---|---|---|---|---|
| [`qwen3.8-27b-4bit`](docs/models/qwen3.8-27b-4bit.md) (default) | the default; best-tested with `reasoning_effort: low` | 122k / 262k / 262k / 262k with `kv_cache_bits: 8` tokens | yes | 53k / 323 / 40 |
