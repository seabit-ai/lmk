...
| `model.name` (click for its page) | HuggingFace repo | weights | notes |
|---|---|---|---|
...
| [`gemma-4-26b-a4b-4bit`](docs/models/gemma-4-26b-a4b-4bit.md) | [mlx-community/gemma-4-26b-a4b-it-4bit](https://huggingface.co/mlx-community/gemma-4-26b-a4b-it-4bit) | 15.6 GB | Google's Gemma 4, a mixture of experts with 4B active: the fastest model here (~120 tokens/s, reads prompts at ~1,800 tokens/s on an M3 Ultra) in 16 GB. Text and images in, tool calls. Thinking is off unless you turn it on, and even off it sometimes thinks briefly. |
