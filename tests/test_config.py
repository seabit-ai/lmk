...
def test_an_unknown_name_points_at_the_list_and_at_repo(tmp_path):
    with pytest.raises(ConfigError, match=r"not in the tested list \(qwen3.8-27b-4bit, qwen3.8-27b-8bit, qwen3.5-122b-a10b-4bit, qwen3.5-122b-a10b-48gb, gemma-4-26b-a4b-4bit, gemma-4-e4b-4bit, gemma-4-31b-4bit\).*model.repo"):
