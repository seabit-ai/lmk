...
export EVAL_RAW_DIR=$PWD/$E/raw EVAL_RUNS=2 EVAL_LIMIT=20 EVAL_PARALLEL=${EVAL_PARALLEL:-2}
...
.venv/bin/python "$H27/run.py" ${ARM:-draft-on} http://127.0.0.1:1236 qwen3.8-27b-4bit code instruct tools > "$S/spec-eval.progress" 2>&1
