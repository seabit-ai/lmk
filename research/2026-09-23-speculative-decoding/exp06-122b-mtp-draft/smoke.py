"""exp06 smoke: exp05 smoke on Qwen3.5-122B-A10B-4bit with its own MTP head (KV_BITS env: 8 to quantize the cache).
...
MAIN = sorted(glob.glob(os.path.expanduser("~/.cache/huggingface/hub/models--mlx-community--Qwen3.5-122B-A10B-4bit/snapshots/*")))[-1]
DRAFT = os.path.expanduser("~/.cache/lmk-research/qwen3.5-122b-a10b-mtp-draft")
MAX_TOKENS = 400
