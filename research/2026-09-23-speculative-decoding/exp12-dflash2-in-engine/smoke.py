"""exp12 smoke: the engine path with the DFlash 2 drafter (KV_BITS env: 8 to quantize the cache).
...
DRAFT = os.path.expanduser("~/.cache/lmk-research/../huggingface/hub/models--incoai--Qwen3.8-27B-DFlash2/snapshots/015e795645c74b1a0eeef3b570031fb62e769bc5")
MAX_TOKENS = 400
