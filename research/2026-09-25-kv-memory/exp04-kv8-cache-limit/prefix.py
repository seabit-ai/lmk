...
# the checkout that holds .venv and .engine (a worktree has neither; run.sh passes the main checkout)
ROOT = Path(os.environ.get("LMK_CHECKOUT") or Path(__file__).resolve().parents[3])
