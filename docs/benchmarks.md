...
| Apple M3 Ultra | 96 GB | qwen3.8-27b-4bit (KV cache 8-bit, speculative decoding) — the model page's recommendation | 262,144 | 322 tok/s (4,034 tokens) | 48k tok/s (3,840 cached; first token 0.91 s) | 37.3 tok/s prose · 49.6 code (88% of drafted tokens accepted) | v0.7.0+ | bc9588e | 2026-09-24 |
